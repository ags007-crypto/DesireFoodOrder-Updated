...
class Lunchorder : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_lunchorder)
        ...
        val table_user: DatabaseReference = database.getReference("customer_lunch")
        btnOrder!!.setOnClickListener {
            ...
            builder.setPositiveButton("Yes"){dialogInterface, which ->
                        ...
                        if (edtName!!.length() > 0 && edtPhone!!.length() >= 10) {
                            ...
                            val pd = ProgressDialog(this@Lunchorder)
            ...
            builder.setNegativeButton("No"){dialogInterface, which ->
                Toast.makeText(this@Lunchorder,"clicked No",Toast.LENGTH_LONG).show()
            }
